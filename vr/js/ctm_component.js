AFRAME.registerComponent('ctm', {
    ...
    init: function () {
        ...
        ctmLoader.load( this.data.src,   function( bufferGeometry ) {
            ...
            mesh.material.map = textureLoader.load('/course/format/vrtopics/vr/textures/' + that.data.name + '.jpg');
        ...
        }, { useWorker: true, worker: new Worker( M.cfg.wwwroot+"/course/format/vrtopics/vr/js/CTMWorker.js" ) } );
