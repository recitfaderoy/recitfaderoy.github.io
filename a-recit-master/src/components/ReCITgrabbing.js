...
AFRAME.registerSystem("track-cursor", {
    init: function() {
      this.el.setAttribute("cursor", { rayOrigin: " " });
    }
  });
...
AFRAME.registerComponent("grabbing", {
  ...
  init() {
    ...
    console.log("Hand mouse    " + this._head.hand)
    this._head.hand.setAttribute(
        "look-controls", { pointerLockEnabled: false, touchEnabled: false },
    )
    console.log("Hand mouse    "+this._head.hand.getAttribute("look-controls"))
...
console.log(this._head.hand.getAttribute("id")) 
    if (this._head.hand.getAttribute("id")== "#camera2")  {this.el.sceneEl.setAttribute("cursor", { rayOrigin: "mouse" });}
  ...
  update(oldData) {
    for (let hand of this._hands) {
      ...
      if (this[_hand].ray)
        ...
        if (this._head.hand.getAttribute("id")== "#camera2")  {this.el.sceneEl.components.cursor.i.setAttribute("rayOrigin","mouse" );}
    }
    console.log(this.el.sceneEl)
    console.log(this.el.sceneEl.components.cursor.i)
  },
